...
/*
다차원 배열 (muti demensional array)중 2차원 배열
: 대차원 배열은 2차원 이상의 배열을 의미하지만 개발 환경상 2차원 배열이상을 다루는 경우는 극히 드물기 때문에 2차원 배열기준으로 강의함

형식:
int[][] arr01 = new int[크기][크기]     -선언방식1
int[][] arr02 = new int[크기][]         - 선언방식2
int[][] arr03 = {{1,2},{3,4},{5,6}};     - 선언3 및 초기화

2차원 배열선언시 열의 크기는 지정하지않아도 되지만 행의 크기는 항상 지정해야함 -> 2번 방식이 해당합니다.
                1열 2열 (column)
                 ↓ ↓
                {1,2},      → 가로줄 : 행 - 0행
                {3,4},                   - 1행
...
public class Arrays13 {
    public static void main(String[] args) {
        ...
        //2차배열은 첫번째 배열의 element의 자료형이 1차배열이라는 점에 주목

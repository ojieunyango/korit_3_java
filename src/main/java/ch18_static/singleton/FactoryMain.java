...
public class FactoryMain {
    public static void main(String[] args) {
        ...
        // 이상의 코드에서 .prduceSmartPhone() 의 리턴 타입이 SmartPhone의 객체였습니다
...
//        System.out.println(smartPhone4);
        ...
        /*
        이상의 코드들을 실행시켰을때 알수있는 점으로 어느공장 객체에서 메서드를 실행시켰는지 간에 creatSerialNumber() 메서드를 호출한
        결과가 일원화되어 시리얼넘버가 부여된다는 점입니다.
         */
